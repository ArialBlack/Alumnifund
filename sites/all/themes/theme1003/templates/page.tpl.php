...
<?php if ( !theme_get_setting( 'theme1003_breadcrumb_show' ) ) :
	$breadcrumb = NULL;
endif; ?>
...
<div id="page-wrapper" class="page-wrapper">
	<div id="page" class="page">
		...
		<header id="header" class="header page-header clearfix" role="banner">
			...
			<div class="<?php if ( theme_get_setting( 'theme1003_sticky_menu' ) ) { echo 'stickup '; } ?>header-section-1"> <!-- Sticky menu wrapper -->
				<div class="clearfix">
					<div class="col1">
						<!-- Logo -->
			...
			<!-- Region Slider -->
			<?php if ( $page['slider'] ) : 
				theme1003_region_preffix ( 'slider' );
					print render( $page['slider'] );
				theme1003_region_suffix ( 'slider' );
			endif; ?>

			<!-- Region Header -->
			<?php if ( $page['header'] ) : 
				theme1003_region_preffix ( 'header' );
					print render( $page['header'] );
				theme1003_region_suffix ( 'header' );
			endif; ?>

			<!-- Region Header bottom -->
			<?php if ( $page['header_bottom'] ) : 
				theme1003_region_preffix ( 'header_bottom' );
					print render( $page['header_bottom'] );
				theme1003_region_suffix ( 'header_bottom' );
			endif; ?>
		</header>
		...
		<div id="main-wrapper" class="main-wrapper" role="main">
			...
			<?php if ( $page['content_top'] ) : 
				theme1003_region_preffix ( 'content_top' );
					print render( $page['content_top'] );
				theme1003_region_suffix ( 'content_top' );
			endif; ?>
			
			<!-- Section one -->
			<?php if ( $page['section_one'] ) : 
				theme1003_region_preffix ( 'section_one' );
					print render( $page['section_one'] );
				theme1003_region_suffix ( 'section_one' );
			endif; ?>
			
			<!-- Section one -->
			<?php if ( $page['section_two'] ) : 
				theme1003_region_preffix ( 'section_two' );
					print render( $page['section_two'] );
				theme1003_region_suffix ( 'section_two' );
			endif; ?>
			...
			<?php if ( $page['section_three'] ) : 
				theme1003_region_preffix ( 'section_three' );
					print render( $page['section_three'] );
				theme1003_region_suffix ( 'section_three' );
			endif; ?>

			<!-- Region Content bottom -->
			<?php if ( $page['content_bottom'] ) : 
				theme1003_region_preffix ( 'content_bottom' );
					print render( $page['content_bottom'] );
				theme1003_region_suffix ( 'content_bottom' );
			endif; ?>

			<!-- Region Section four -->
			<?php if ( $page['section_four'] ) : 
				theme1003_region_preffix ( 'section_four' );
					print render( $page['section_four'] );
				theme1003_region_suffix ( 'section_four' );
			endif; ?>
		</div>
		...
		<footer id="footer" class="footer page-footer" role="contentinfo">
			...
			<?php if ( $page['footer_top'] ) : 
				theme1003_region_preffix ( 'footer_top' );
					print render( $page['footer_top'] );
				theme1003_region_suffix ( 'footer_top' );
			endif; ?>
					...
					<div class="container-12">
						...
						<div class="grid-4">
							...
							<?php if ( $page['footer_two'] ) :
								print render( $page['footer_two'] );
							endif; ?>
						</div>
						<div class="grid-3">
							<!-- Region Footer three -->
							<?php if ( $page['footer_three'] ) :
								print render( $page['footer_three'] );
							endif; ?>
						</div>
					</div>
				</div>
				...
				<div class="footer-section-2">
					<div class="container-12">
						<div class="grid-12 clearfix">
							...
							<?php if ( $is_front ) : ?>
								More <a rel="nofollow" href="http://www.templatemonster.com/category/science-lab-drupal-themes/" target="_blank">Science Lab Drupal Themes at TemplateMonster.com</a>
							<?php endif; ?>
						</div>
					</div>
				</div>
